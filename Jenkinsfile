    ...
    stages {
        stage('Build Server') {
            steps {
                ...
                sh 'cd ./WebServer && ./node_modules/.bin/istanbul cover --include-all-sources --root ./bin/ ./node_modules/mocha/bin/_mocha bin/test/**/*.js bin/test/*.js && ./node_modules/.bin/istanbul check-coverage --functions 100'
